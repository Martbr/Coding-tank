...
public class Menus {
    ...
    public static void menuCadastro() {
        ...
        System.out.println("\n###_ Menu cadastro _###");
        login = validaTexto("Digite seu Login: ", "Digite novamente sem deixar espaços em branco ou vazio! ");
        if (loginExist(login)) {
            System.out.println("\nEste login já existe, digite um novo: ");
            menuCadastro();
        } else {
            name = validaTexto("Digite seu Nome: ", "Seu nome não pode ser em branco ou vazio! ");
            password = validaTexto("Digite sua Senha: ", "Sua senha não pode ser vazia ou em branco! ");
    ...
    public static String validaTexto(String msg, String msgError) {
        String txt;
    ...
    public static void menuPostagem(int pos) {
